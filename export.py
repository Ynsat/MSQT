...
def export_to_asset(asset, asset_type, asset_id, region, scale=30):
    ...
    # TODO - add a overwrite method

    user_path = GEE_USER_PATH + "/hackathon"
...
def track_task(task):
    ...
    if task:  # in case an asset already exists a new task is not started. Instead the existing asset is used.
        return True
